...
const timelineContent = [
    ...
    {
        content: 'Инициатор проведения первого Липецкого регионального Гражданского Форума (проводится до настоящего времени)',
        year: 'В 2005 г.'
    },
    {
    ...
    {
        content: 'Инициатор создания Клуба лидеров НКО Липецкой области (действует до настоящего времени)',
        year: 'В 2011 г.'
    },
    {
    ...
    {
        content: 'ЛООП «Защита» стала первой из СО НКО Липецкой области поставщиком социально-правовых услуг',
        year: 'В 2014 г.'
    },
    {
