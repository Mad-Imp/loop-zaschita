...
export default function OrganizationHistory() {
    return <div>
        ...
        <div className={styles.block}>
            <div className={styles.item}>
                <img className={styles.photo} src="./team.jpg" alt="Коллектив"/>
                ...
                <p>За эти годы около 37&nbsp;тыс. вкладчиков («Русский дом селенга», «Русская недвижимость»,
                    ...
                    «Защита» принимала участие в&nbsp;1996&nbsp;-&nbsp;1997&nbsp;гг.
                </p>
            </div>
            <div className={styles.item}>
                ...
                <p className={styles.meeting}>По результатам деятельности ЛООП «Защита» ее председатель Родионов В.И.
                    был приглашен 12 июня 2001
                    г. на встречу Президента РФ Путина В.В. в Кремле с представителями общественных объединений.</p>
                <img className={styles.photo} src="./meeting.jpg" alt="Встреча с Владимиром Путиным"/>
